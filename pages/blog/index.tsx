...
import { Layout, Hyperlink, Heading, Divider, Paragraph, Picture } from '../../components/index';
...
Page.getLayout = function getLayout(page: ReactElement) {
  return <Layout header={{ heading: 'Blog', icon: <FolderIcon width={20} height={20} /> }}>{page}</Layout>;
};
